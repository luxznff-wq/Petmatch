...
sobre los datos, subida de archivos, **peticiones simultáneas** y fechas
independientes del huso horario. Incluye los casos negativos que pide
...
**Frontend (134 pruebas).** Componentes reutilizables, tarjetas de mascota, tabla de
